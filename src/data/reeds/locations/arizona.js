...
const A = (id, label, q, region, lat, lng, tags, notes) =>
  us({ id, label, q, state: "AZ", region, lat, lng, flag: "🌵", tags: tags || [], notes: notes || "" });

/** Southeast AZ list intentionally excludes Sierra Vista per user preference */
export const ARIZONA = [
  ...
  ...[
    ...
    ["bisbee-az", "Bisbee, AZ", "Bisbee, AZ", "Tucson Metro & South", 31.4482, -109.9284, ["historic"]],
    ...
    ["tombstone-az", "Tombstone, AZ", "Tombstone, AZ", "Tucson Metro & South", 31.7129, -110.0656, ["historic"]],
    ["willcox-az", "Willcox, AZ", "Willcox, AZ", "Tucson Metro & South", 32.2529, -109.8328, ["ag"]],
  ].map(([id, label, q, rg, la, ln, tg]) => A(id, label, q, rg, la, ln, tg, "")),

  // Southeast / Sky Islands (no Sierra Vista)
  ...[
